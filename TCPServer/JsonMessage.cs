...
namespace Oni.Server
{
    public class JsonMessage
    {
        ...
        public enum TargetEnum { None = -1, AllPlayersInTheRoom, OtherPlayersInTheRoom, AllPlayers, OtherPlayers }
        ...
        public void ReadEnd()
        {
            ...
            string json = Encoding.UTF8.GetString(buffer, BasicType.HEADSIZE, len - BasicType.HEADSIZE);
        ...
        {
            Data.TryGetValue(key, out JToken token);
            string value = token.ToString().ToLower();
            result = value == "true";
        }
